/* ==========================================================================
   PROJECT: MAD OVERLORD // RESEARCH LAB KIOSK CONTROLLER (MVVM) (v2)
   ========================================================================== */
...
export class LabController {
    constructor(switchScreenFn) {
        ...
        this.domDmCount = document.getElementById('lab-dm-count-v2');
        this.domPartsGrid = document.getElementById('parts-grid-v2');
        this.domCartCost = document.getElementById('cart-cost-v2');
        this.btnEquip = document.getElementById('btn-equip-confirm-v2');

        // MVVM 스탯 피드백 DOM
        this.statHp = document.getElementById('stat-hp-val-v2');
        this.statDps = document.getElementById('stat-dps-val-v2');
        this.statRange = document.getElementById('stat-range-val-v2');
        this.statSpeed = document.getElementById('stat-speed-val-v2');
        this.statSkill = document.getElementById('stat-skill-desc-v2');

        this.initEvents();
    }

    initEvents() {
        const btnBack = document.getElementById('btn-lab-back-v2');
        if (btnBack) {
    ...
    showNotification(msg, type = 'success') {
        ...
        el.textContent = msg;
        const container = document.querySelector('.lab-frame-v2');
